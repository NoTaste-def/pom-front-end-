        ...
        <div className={styles.Contents}>
          <div className={styles.showResume}>
                  ...
                  return (
                    <div key={i} className={styles.hisElement}>
                      <div>
                        <p>
                          입사기간 :{" "}
                          {user ? user.history[i].history_period : LOAD}
                        </p>
                        <p>
                          회사이름 :{" "}
                  ...
                  return (
                    <div key={i} className={styles.techElement}>
                      <div>
                        <p>
                          기술 자격증 이름 :{" "}
                          {user ? user.tech[i].tech_name : LOAD}
                        </p>
                        <p>
                          취득일 : {user ? user.tech[i].tech_get_day : LOAD}
                        </p>
                        <p>
                          발급처 : {user ? user.tech[i].tech_authority : LOAD}
                        </p>
                        <p>
                          인증여부 :{" "}
                  ...
                  return (
                    <div key={i} className={styles.langElement}>
                      <div>
                        <p>
                          어학 자격증 이름 :{" "}
                          {user ? user.voca[i].voca_name : LOAD}
                        </p>
                ...
                user.awards.map((a, i) => {
                  return (
                    <div key={i} className={styles.awardElement}>
                      <div>
                        <p>
                          수상이름 : {user ? user.awards[i].awards_name : LOAD}
                        </p>
                        <p>
                          대회주최기관 :{" "}
                        ...
                        <p>
                          취득일 : {user ? user.awards[i].awards_get : LOAD}
                        </p>
                      </div>
                    </div>
                  );
            ...
            <div className={styles.NavContainer}>
              <span onClick={() => {}}>학력사항</span>
              <span onClick={() => {}}>병역사항</span>
              <span onClick={() => {}}>경력사항</span>
              <span onClick={() => {}}>자격증</span>
              <span onClick={() => {}}>수상내역</span>
            </div>
          </div>
        </div>
      </div>
